...
export default function HomePage() {
  return (
    <>
      <Helmet>
        <title>Driving Lessons Stoke | DriveOn Academy</title>
        <meta
          name="description"
          content="Professional driving lessons in Stoke-on-Trent. Manual and automatic driving lessons with high pass rates. Book your first lesson today."
        />
        <meta
          name="keywords"
          content="driving lessons Stoke, driving school Stoke-on-Trent, automatic driving lessons Stoke, manual driving lessons Stoke"
        />
        <meta name="author" content="DriveOn Academy" />

        {/* Open Graph (for social media) */}
        <meta property="og:title" content="DriveOn Academy Driving Lessons" />
        <meta
          property="og:description"
          content="Learn to drive with confidence. Professional driving lessons in Stoke-on-Trent."
        />
        <meta property="og:url" content="https://www.driveonacademy.co.uk/" />
            ...
            <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="max-w-2xl">
                ...
                <p className="mt-6 max-w-xl text-pretty text-lg leading-8 text-muted-foreground sm:text-xl">
                  Professional driving instruction tailored to your pace.
                  Whether you're starting from scratch or refreshing your
                  skills, we’ll help you become a safe, confident, and
                  test-ready driver.
                </p>
              ...
              <div className="relative grid items-center gap-8 lg:grid-cols-[0.95fr_1.05fr]">
                ...
                <div>
                  ...
                  <p className="mt-4 max-w-2xl text-lg leading-8 text-primary-foreground/80">
                    ...
                    driving independence. Join learners who built their
                    confidence with calm, supportive instruction.
                  </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Join hundreds of confident drivers who started their journey
                here.
              </p>
            </div>
